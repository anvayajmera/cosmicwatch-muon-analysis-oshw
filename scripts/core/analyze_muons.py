...
<<<<<<<< HEAD:scripts/analysis/analyze_muons.py
...
OUT_FILE = RESULTS_DIR / "clean_muon_dataset.csv"
REPORT_FILE = RESULTS_DIR / "session_ingest_report.csv"
>>>>>>>> 509b85d (Reorganize analysis pipeline, regenerate outputs, and clean repo structure):scripts/core/analyze_muons.py
...
========
    sessions = discover_session_paths(PROJECT_ROOT)
>>>>>>>> 509b85d (Reorganize analysis pipeline, regenerate outputs, and clean repo structure):scripts/core/analyze_muons.py
